        ...
        <Container disableGutters className={classes.sideLinks}>
          <Tooltip title="Home">
            <Link href="/" color="inherit" activeClassName="active" className={classes.sideNavLink}>
              <FingerprintSharp className={classes.navLinkIcon} />&nbsp;{!isCollapsed?'Home':''}
            </Link>
          </Tooltip>
          <Tooltip title="Pages">
            <Link href="/example" color="inherit" activeClassName="active" className={classes.sideNavLink}>
              <FiberSmartRecordSharp className={classes.navLinkIcon} />&nbsp;{!isCollapsed?'Example pages':''}
            </Link>
          </Tooltip>
          <Tooltip title={isDarkTheme?'Light':'Dark'}>
            ...
            {isDarkTheme?<ExposurePlus1Sharp className={classes.navLinkIcon}  />:<ExposureNeg1Sharp className={classes.navLinkIcon} />}&nbsp;{!isCollapsed?(isDarkTheme?'Light':'Dark'):''}
            </Link>
          </Tooltip>
        </Container>
      </Box>
