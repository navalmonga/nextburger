...
const burgerIcon = () => (
  <Tooltip title="Your Brand Here - Fues Pro™" style={{ display: 'block', margin: '0 auto' }}>
    <Link href="/">
...
export default function Index() {
  ...
  const useStyles = makeStyles((theme) => ({
    ...
    textPaper: {
      ...
      margin: isCollapsed? '2rem auto 2rem 11rem': '2rem auto 2rem 15rem',
      width: isCollapsed? '80%': '70%',
      ...
      <Grid item sm={12} md={12} className={classes.contentContainer}>
        ...
        <Paper className={classes.textPaper}>
          <Box m={0} className={classes.heroBox}>
            { burgerIcon() }
            <Typography variant="h3" component="h1" id="brandName" gutterBottom>
              NextBurger 🍔
            </Typography>
            <Typography variant="h4" component="h1" color="textSecondary" gutterBottom>
              Build faster with burger&trade;
            </Typography>
            <Typography variant="body1" component="p" color="secondary" gutterBottom>
              A NextJS + MaterialUI boilerplate equipped with a custom CLI for page &amp; component management. Deploy a blazing fast SSR front-end application built and designed by Fues Pro&trade;. Look here for more information and steps on how to install.
            </Typography>
            ...
            <Typography variant="body1" component="p" color="secondary" gutterBottom>
              This project was bootstrapped with the <a className={classes.link} href="https://github.com/mui-org/material-ui/tree/master/examples/nextjs" alt="github">Material-UI NextJS example.</a>
            </Typography>
            <Typography variant="h5" component="h1" gutterBottom>
              Quickstart
            </Typography>
